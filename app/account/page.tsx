		...
		<main className="min-h-screen bg-zinc-950 px-5 py-10 text-white">
			<header className="mx-auto flex w-full max-w-5xl items-center justify-between">
				...
				<div className="flex items-center gap-2">
					<Link
						href="/"
						className="rounded-full bg-zinc-900 px-4 py-2 text-sm font-bold text-zinc-300 ring-1 ring-white/10 transition hover:bg-zinc-800 hover:text-white"
					>
						{t.back}
					</Link>
					...
					<button
						...
						disabled={loggingOut}
						className="rounded-full bg-orange-400 px-4 py-2 text-sm font-bold text-black transition hover:bg-orange-300 disabled:cursor-not-allowed disabled:opacity-50"
					>
